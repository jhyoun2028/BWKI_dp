...
|---|---|---|---|---|
| baseline_tfidf_logreg | 7 / 18 | 1 / 86 | 0.3889 | 0.9884 |
| baseline_tfidf_logreg_nourl | 9 / 18 | 0 / 86 | 0.5 | 1.0 |
| distilbert_multilingual | 2 / 18 | 9 / 86 | 0.1111 | 0.8953 |

Die Fehler überschneiden sich kaum: Baseline und DistilBERT liegen bei **2 von 17** Zeilen gemeinsam falsch. Beide Modelle irren also an verschiedenen Stellen.

## Die 17 falsch eingeordneten Zeilen
...
**PHISHING** · p_baseline 0.88 · p_nourl 0.82 · p_distilbert 0.03  
...
**PHISHING** · p_baseline 0.84 · p_nourl 0.85 · p_distilbert 0.04  
...
**legitim** · p_baseline 0.54 · p_nourl 0.51 · p_distilbert –  
...
**legitim** · p_baseline 0.69 · p_nourl 0.68 · p_distilbert –  
> Herr Neumann, Ihre Bestellung von Elektro Hansen ist unterwegs und wird bis 18:00 Uhr eintreffen. Lieferung verfolgen: <URL>  
Echte Versandbenachrichtigung; „Ihre Bestellung“ + Uhrzeit reicht dem Modell schon für Verdacht.

**PHISHING** · p_baseline 0.51 · p_nourl 0.59 · p_distilbert 0.02  
...
**legitim** · p_baseline 0.29 · p_nourl 0.45 · p_distilbert 0.91  
...
**legitim** · p_baseline 0.82 · p_nourl 0.88 · p_distilbert –  
...
**PHISHING** · p_baseline 0.47 · p_nourl 0.62 · p_distilbert 0.13  
...
**PHISHING** · p_baseline 0.91 · p_nourl 0.81 · p_distilbert 0.20  
...
**PHISHING** · p_baseline 0.68 · p_nourl 0.55 · p_distilbert 0.01  
...
**legitim** · p_baseline 0.86 · p_nourl 0.80 · p_distilbert –  
...
**legitim** · p_baseline 0.54 · p_nourl 0.73 · p_distilbert –  
> Danke für Ihre Bestellung bei Weinhandel Rebstock, Frau Wagner! Wir schicken Ihnen eine SMS, wenn Ihre Bestellung versandt wurde.  
Bestellbestätigung. Knapp über der Schwelle (0.54) – solche Grenzfälle kippen mit jedem neuen Trainingslauf.

**PHISHING** · p_baseline 0.73 · p_nourl 0.76 · p_distilbert 0.01  
...
**PHISHING** · p_baseline 0.60 · p_nourl 0.58 · p_distilbert 0.46  
> Neue Voicemail: https://[Link]  
Der Link ist im Quelltext unbrauchbar notiert; p=0.46 liegt knapp unter der Schwelle.

**legitim** · p_baseline 0.87 · p_nourl 0.78 · p_distilbert 0.96  
...
**PHISHING** · p_baseline 0.88 · p_nourl 0.85 · p_distilbert 0.42  
...
**legitim** · p_baseline 0.58 · p_nourl 0.67 · p_distilbert –  
...
Fehlalarmrate (legitim nicht grün) 0.444 · legitim → rot 0.111 · Phishing → rot 0.907. Aktives Modell: `baseline_tfidf_logreg`.
